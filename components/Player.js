  ...
  return (
    <div className="h-24 bg-gradient-to-b from-black to-gray-900 text-white grid grid-cols-3 text-xs md:text-base px-2 md:px-8">
      ...
      <div className="flex items-center justify-evenly">
        ...
        <RewindIcon className="player-btn" />
        {isPlaying ? (
          <PauseIcon onClick={handlePlayPause} className="player-btn" />
        ) : (
          <PlayIcon onClick={handlePlayPause} className="player-btn" />
        )}
        <FastForwardIcon className="player-btn" />
